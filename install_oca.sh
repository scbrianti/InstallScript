...
# wget https://raw.githubusercontent.com/scbrianti/InstallScript/12.0/install_oca.sh
# Place this content in it and then make the file executable:
# sudo chmod +x install_oca.sh
...
$OE_EXTRA/oca-server-tools/,$OE_EXTRA/oca-connector-telephone/,$OE_EXTRA/oca-web/,\
$OE_EXTRA/oca-partner-contact/,$OE_EXTRA/oca-crm/,$OE_EXTRA/oca-l10n-brazil/,\
$OE_EXTRA/oca-helpdesk/,$OE_EXTRA/oca-social/,$OE_EXTRA/oca-server-auth/,$OE_EXTRA/oca-rest-framework/"
