...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/product-attribute.git $OE_EXTRA/oca-product-attribute/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/product-variant.git $OE_EXTRA/oca-product-variant/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/bank-payment.git $OE_EXTRA/oca-bank-payment/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/timesheet.git $OE_EXTRA/oca-timesheet/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/search-engine.git $OE_EXTRA/oca-search-engine/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/mis-builder.git $OE_EXTRA/oca-mis-builder/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/queue.git $OE_EXTRA/oca-queue/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/knowledge.git $OE_EXTRA/oca-knowledge/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/manufacture-reporting.git $OE_EXTRA/oca-manufacture-reporting/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/data-protection.git $OE_EXTRA/oca-data-protection/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/stock-logistics-workflow.git $OE_EXTRA/oca-stock-logistics-workflow/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/account-analytic.git $OE_EXTRA/oca-account-analytic/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/manufacture.git $OE_EXTRA/oca-manufacture/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/bank-statement-import.git $OE_EXTRA/oca-bank-statement-import/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/server-ux.git $OE_EXTRA/oca-server-ux/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/stock-logistics-reporting.git $OE_EXTRA/oca-stock-logistics-reporting/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/account-financial-tools.git $OE_EXTRA/oca-account-financial-tools/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/server-backend.git $OE_EXTRA/oca-server-backend/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/vertical-hotel.git $OE_EXTRA/oca-vertical-hotel/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/account-invoice-reporting.git $OE_EXTRA/oca-account-invoice-reporting/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/account-payment.git $OE_EXTRA/oca-account-payment/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/donation.git $OE_EXTRA/oca-donation/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/multi-company.git $OE_EXTRA/oca-multi-company/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/interface-github.git $OE_EXTRA/oca-interface-github/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/website.git $OE_EXTRA/oca-website/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/maintenance.git $OE_EXTRA/oca-maintenance/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/server-env.git $OE_EXTRA/oca-server-env/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/geospatial.git $OE_EXTRA/oca-geospatial/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/commission.git $OE_EXTRA/oca-commission/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/contract.git $OE_EXTRA/oca-contract/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/delivery-carrier.git $OE_EXTRA/oca-delivery-carrier/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/credit-control.git $OE_EXTRA/oca-credit-control/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/connector-interfaces.git $OE_EXTRA/oca-connector-interfaces/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/website-cms.git $OE_EXTRA/oca-website-cms/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/vertical-association.git $OE_EXTRA/oca-vertical-association/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/event.git $OE_EXTRA/oca-event/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/sale-reporting.git $OE_EXTRA/oca-sale-reporting/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/management-system.git $OE_EXTRA/oca-management-system/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/e-commerce.git $OE_EXTRA/oca-e-commerce/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/account-budgeting.git $OE_EXTRA/oca-account-budgeting/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/stock-logistics-tracking.git $OE_EXTRA/oca-stock-logistics-tracking/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/purchase-reporting.git $OE_EXTRA/oca-purchase-reporting/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/currency.git $OE_EXTRA/oca-currency/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/account-closing.git $OE_EXTRA/oca-account-closing/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/edi.git $OE_EXTRA/oca-edi/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/rma.git $OE_EXTRA/oca-rma/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/ddmrp.git $OE_EXTRA/oca-ddmrp/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/calendar.git $OE_EXTRA/oca-calendar/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/operating-unit.git $OE_EXTRA/oca-operating-unit/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/community-data-files.git $OE_EXTRA/oca-community-data-files/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/intrastat-extrastat.git $OE_EXTRA/oca-intrastat-extrastat/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/report-print-send.git $OE_EXTRA/oca-report-print-send/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/project-agile.git $OE_EXTRA/oca-project-agile/
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/OCA/margin-analysis.git $OE_EXTRA/oca-margin-analysis/
